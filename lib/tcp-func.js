            ...
            if( err ) {
                ...
                fs.unlink( filePath , err => {
                    ...
                    if( err ) {
                        ...
                        // CHMOD or other rules access have denied remove file
                        this.emit('remove file error' , {
                            filePath: filePath ,
                            filename: filename
                        } ) ;
...
// emit blur for reset state shortcuts client-side
function haveBlur({win}) {
